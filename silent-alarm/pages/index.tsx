...
const Home: NextPage = () => {
	return (
		<Box>
			<SEO
				title="Silent Alarm"
				description="The smoke detector detector for people who are deaf or hard of hearing"
			/>
			<Box>
				<HeroSection />
				...
				features={[
					{
						title: "Accessible",
						icon: FiSmile,
						description: "Built for people who cannot hear",
						iconPosition: "left",
						delay: 0.6,
					},
					{
						...
						icon: FiSliders,
						description:
							"Just turn it on, and it will alert you when a smoke detector goes off. Or, open your phone to see its current status",
						iconPosition: "left",
						delay: 0.8,
					},
					{
						...
						icon: FiGithub,
						description:
							"All of the code for this project is on our Github page.",
						iconPosition: "left",
						delay: 1,
					},
					{
						...
						icon: FiUsers,
						description:
							"This project was created entirely by students for the HackViolet 2024 hackathon",
						iconPosition: "left",
						delay: 1.1,
					},
				]}
...
const FeaturesSection = () => {
	return (
		<Features
			...
			description={
				<>
					Saas UI Pro includes everything you need to build modern
					frontends.
					<Br />
					Use it as a template for your next product or foundation for
					your design system.
				</>
			}
			align="left"
			...
			features={[
				...
				},
				{
					...
					description: (
						<>
							All code is available as packages in a
							high-performance{" "}
							<Link href="https://turborepo.com">Turborepo</Link>,
							you have full control to modify and adjust it to
							your workflow.
						</>
					),
					variant: "inline",
...
export async function getStaticProps() {
	return {
		props: {
			announcement: {
				title: "This website is still in development!",
